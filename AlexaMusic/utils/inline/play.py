...
def stream_markup_timer(_, videoid, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(
                text=" ᴏᴡɴᴇʀ 💞", url=f"https://t.me/itsnein"
            ),
        ],
        [
            InlineKeyboardButton(
            ...
            InlineKeyboardButton(text="ᴀʟᴇxᴀ ᴄʜᴀᴛ 💌", url=f"https://t.me/neinplay"),
        ],
        [
            InlineKeyboardButton(
                text=f"☀ ᴀʟᴇxᴀ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ☀",
                url=f"https://t.me/neinplay",
            )
        ],
    ]
    return buttons
...
def telegram_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(
                text="ᴏᴡɴᴇʀ 💞", url=f"https://t.me/neinplay"
            ),
        ],
        [
            InlineKeyboardButton(
